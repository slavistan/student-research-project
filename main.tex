...
\section{Performance Benchmarks}
  ...
  \subsection{Generation of structured grid adjacency matrices as test matrices}
    ...
    Note that as the two matrices share the same structure their only difference is found in \V. The small matrix primarily utilizes the second matrix-vector multiplication scheme (Figure \ref{fig:simd_scheme_diag_collated}) while the large matrix mainly relies on the first scheme (Figure \ref{fig:simd_scheme_diag}).
